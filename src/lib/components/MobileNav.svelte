...
<nav
  class="fixed bottom-0 left-0 z-50 flex w-full items-center backdrop-blur-3xl justify-around border-t border-white/5 bg-background px-6 py-3"
>
  <button
    onclick={() => goto("/menu")}
    class={active == "menu"
  ...
  <button
    class="relative -mt-10 flex h-16 w-16 items-center justify-center rounded-full border-4 bg-[#f54504] shadow-2xl shadow-[#C41E3A]/40"
    class:border-amber-500={active == "cart"}
    class:border-stone-950={active !== "cart"}
    onclick={() => goto("/cart")}
  >
    <svg
      xmlns="http://www.w3.org/2000/svg"
    ...
    class:text-stone-950={active !== "cart"}        d="M21 4H6.17l-.18-1.15A1 1 0 0 0 5 2H2v2h2.14l1.87 12.15A1 1 0 0 0 7 17h12v-2H7.86l-.31-2H19c.45 0 .84-.3.96-.73l2-7A1 1 0 0 0 21 3.99Zm-2.75 7H7.24l-.77-5h13.2l-1.43 5ZM8 18a2 2 0 1 0 0 4 2 2 0 1 0 0-4m9 0a2 2 0 1 0 0 4 2 2 0 1 0 0-4"
      ></path>
    </svg>
  </button>
  <button
  ...
  >
    <span
      ...
      >
        ...
        ></path><path d="M6 7h8v2H6zm0 4h8v2H6zm5 4h3v2h-3z"></path>
      </svg></span
    >
